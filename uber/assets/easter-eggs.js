(()=>{
  ...
  function p1klz(){
    ...
    `,`<div class="eye"></div><div class="ai-copy"><b>P1-KLS ONLINE</b>I HAVE REVIEWED YOUR BROWSING HISTORY.<br><br>BOLD CHOICES.<br><br>Also, this website is very nice.</div>`);
  }
  function year1887(){
    mount(`
