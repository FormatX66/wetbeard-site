...
| Scene navigation | room reload, broken browser Back, journal travel reloads, mission route reloads, pushState, popstate, continuity | `patterns/seamless-rendered-scene-navigation.md` |
