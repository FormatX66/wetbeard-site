...
| Local identity console | callsign switcher, local profile, preserve room, new anonymous slot, no query editing | `patterns/in-world-local-identity-switching.md` |
